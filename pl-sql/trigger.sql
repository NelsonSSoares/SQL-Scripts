...
Alterar a trigger verifica_valor da apostila para que também sejam 
incluídos na tabela valor_produto a data do sistema no momento da 
atualização e o nome do usuário que realizou a alteração no campo valor.
*/
...
excluído, gravando nos campos abaixo os seguintes valores:

USER_NAME = User
TIMESTAMP = Data sistema
EMPNO = Código antigo do empregado
...
OLD_MGR = Código antigo do gerente do empregado
NEW_MGR = Código novo do gerente do empregado
OLD_SAL = Salário antigo do empregado
NEW_SAL = Salário novo do empregado
